...
import {Choice, GroupedSingleChoiceQuestion, Question, SingleChoiceQuestion} from '../dataModels/SurveyDefinition';
...
export class SurveyQuestionChoiceSelectorComponent implements OnInit {
  @Input() element:SingleChoiceQuestion|GroupedSingleChoiceQuestion
